 ...
 * @author Sergio
 */
public class TableScan extends SourceOperation {
    ...
    public TableScan(String sourceName, Table table) {
        super(sourceName);
        this.table = table;
    }
    ...
    public void open() throws Exception {
        ...
        super.open();
        currentBlock = 0;
        currentBlock_ = table.getBlock(table.getFirstBlock());
        iterator = currentBlock_.iterator();
        
        lastBlock = table.getLargestBlock();
        currentRecord = -1;
        nextTuple = null;
        reachedEnd = false;
    }
