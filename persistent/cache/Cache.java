...
import ibd.persistent.AbstractPageFile;
 ...
 * @param <P> Page type
 */
public abstract class Cache<P extends Page> extends AbstractPageFile<P> {
    ...
    @Override
    public void setPageSerializationListener(PageSerialization serializationListener) {
        file.setPageSerializationListener(serializationListener);
    }
